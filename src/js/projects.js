(function () {
	...
	const _navigatorMaster = document.body;
	const _detailCloseButton = document.querySelector('#details > .close');
	...
	_detailCloseButton.addEventListener('click', onDetailClose);
	...
	function nextProject() {
		if(projectsVisible && _navigatorMaster.dataset.active !== ACTIVE_PROJECT_BODY_CLASS) {
	...
	function openProject(index){
		requestAnimationFrame(() => {
			_navigatorMaster.dataset.active = ACTIVE_PROJECT_BODY_CLASS;
